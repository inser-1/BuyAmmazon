...
<div id="register" class="wrap">
    <div class="shadow">
        ...
        <div class="box">
            ...
            <form id="regForm" method="post" action="${pageContext.request.contextPath}/UserServlet?method=registe" onsubmit="return checkForm(this)" accept-charset="UTF-8">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input class="text" type="password" id="passWord1" name="password" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td ><input type="radio" name="sex"  style="border:0px;" checked="checked" value="男" />男<input type="radio" name="sex" style="border:0px;" value="女"/>女<span></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input class="text" type="text" name="idcard" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input class="text" type="text" name="telephone" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
                    </tr>
                    <tr>
